...
function main(wantedLocation) {
    ...
    console.log("[!] Credits: @dolphinalt, @dolphincyber, @Orlando-c, @raisinbran25, @BobTheFarmer on github. Large thanks to Ethan for busting his ass off to finish this project.")
    const data = null;
